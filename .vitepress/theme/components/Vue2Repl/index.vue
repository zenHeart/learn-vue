...
store.setImportMap({
  imports: {
    "@vue/composition-api":  "https://cdn.jsdelivr.net/npm/@vue/composition-api@1.7.2/dist/vue-composition-api.esm.js"
  }
})
...
function updateExample(scroll = false) {
  if (Object.keys(data.value).length === 0) {
    console.warn('No data loaded for')
    return // 等待数据加载
  }
...
<template>
  <section class="learning-path">
    ...
    <Repl :store="store" :showCompileOutput="false" layout="vertical" />
  </section>
</template>
